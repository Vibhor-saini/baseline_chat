(function () {
    ...
    document.addEventListener("livewire:init", () => {
        ...
        function connectToConversation(conversationId) {
            ...
            Echo.channel(activeChannel).listen(".message.sent", (event) => {
    ...
    Echo.channel("conversations").listen(".conversation.updated", (event) => {
    ...
    document.querySelectorAll(".status-item").forEach((btn) => {
        btn.addEventListener("click", function () {
            document
                ...
                .forEach((b) => b.classList.remove("status-active"));
